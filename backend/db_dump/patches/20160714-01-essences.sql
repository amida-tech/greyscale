CREATE OR REPLACE FUNCTION patch_20160714_01_essences() RETURNS void AS
$BODY$
DECLARE
    schema_name text;
BEGIN
	FOR schema_name IN
		...
		EXECUTE 'INSERT INTO "Essences" '
            ...
            || 'values ('
            || quote_literal('TaskUserStates') || ', '
						|| quote_literal('TaskUserStates') || ', '
						|| quote_literal('taskuserstates') || ', '
						|| quote_literal('stateId') || ');';
...
SELECT patch_20160714_01_essences();
DROP FUNCTION IF EXISTS public.patch_20160714_01_essences();
