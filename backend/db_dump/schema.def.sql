...
--
-- Name: SurveyAnswers_surveyId_userId_key; Type: CONSTRAINT; Schema: ${SCHEMA}; Owner: postgres; Tablespace: 
--
...
--
-- Name: SurveyAnswers_surveyId_fkey; Type: FK CONSTRAINT; Schema: ${SCHEMA}; Owner: postgres
--
...
--
-- Name: ${SCHEMA}; Type: ACL; Schema: -; Owner: Jacob
--
